...
public class RegisterCenter implements IRegisterCenter4Invoker, IRegisterCenter4Provider, IRegisterCenter4Governance {
    ...
    private static String ZK_SERVICE = PropertyHelper.getZkService();
    private static int ZK_SESSION_TIME_OUT = PropertyHelper.getZkConnectionTimeout();
    private static int ZK_CONNECTION_TIME_OUT = PropertyHelper.getZkConnectionTimeout();
    ...
    @Override
    public Pair<List<ProviderService>, List<InvokerService>> queryProviderAndInvokers(String serviceName, String appKey) {
        //服务消费者列表
